import { ProductAlertPriorityType } from './product-alert.enum';
...
export type ProductAlertsType = {
  priceAlert: ProductAlertPriorityType;
  technicalDocAlert: ProductAlertPriorityType;
  securityDocAlert: ProductAlertPriorityType;
  stockAlert: ProductAlertPriorityType;
  daysAlert: ProductAlertPriorityType;
  gotsApprovalLetterAlert: ProductAlertPriorityType;
};
