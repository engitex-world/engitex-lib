...
export const COLOR_TONES_PALETTE = [
  ...
  {
    type: ColorToneType.ORANGE,
    shades: ['#FFE0B2', '#FFB74D', '#E65100', 'FF5F1F'],
  }, // Light, Medium, Dark Orange
  {
    type: ColorToneType.YELLOW,
    shades: ['#FFF9C4', '#FFF176', '#F57F17', '#FFFF33'],
  }, // Light, Medium, Dark Yellow
  {
    type: ColorToneType.GREEN,
    shades: ['#C8E6C9', '#81C784', '#1B5E20', '#74EE15'],
