  ...
  switch (attempt) {
    ...
    case 3:
      ...
      if (filteredWords.length >= 3) {
        return (
          filteredWords[1][0].toUpperCase() + filteredWords[2][0].toUpperCase()
        );
      } else if (filteredWords.length >= 2) {
        return (
          filteredWords[1][0].toUpperCase() + filteredWords[0][1].toUpperCase()
        );
      }
      break;
    case 4:
    ...
    default:
      ...
      return (
        filteredWords[0].substring(0, 2).toUpperCase() +
