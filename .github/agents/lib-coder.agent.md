...
- O element type (`[Entity]Lookup`) vive **dentro do ficheiro do contrato** — nunca em `types/`
- Exporta ambos: `[Entity]Lookup` (elemento) e `Lookup[Entity]sResponse` (resposta da API)
